...
**CloudFormation Template Location:** [GitLab Runner Template](https://github.com/arinatechnologies/blogs/blob/main/code/gitlab-runner/main.yml)

**CloudFormation Template Location:** [GitLab Runner Scaling Group / Cluster Template](https://github.com/arinatechnologies/blogs/blob/main/code/gitlab-runner/runner-scaling.yml)
