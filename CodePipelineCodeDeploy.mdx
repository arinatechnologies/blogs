...
date:'2024-02-13'
image:'https://www.arinatechnologies.com/assets/images/blog/smcodepipeline.webp'
tags: ['AWS','CodePipeline','DevOps']
 ---
...
1. In account 1, open the AWS KMS console(https://console.aws.amazon.com/kms/).
