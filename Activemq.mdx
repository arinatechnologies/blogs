...
<table className="ActiveMQ">
                                         ...
                                         <tr>
                                         <td>Connectors</td>    
                                         <td>OpenWire,NIO,AMQP,STOMP,VM (OpenWire only),HTTP (OpenWire-based),MQTT,WebSocket (STOMP and 
                                         MQTT)</td>        
                                          <td>protocols=OpenWire (version 10+), -, protocols=AMQP, protocols=STOMP,    
                                          InVM (all protocols,peer to tcp), -, protocols=MQTT, handled by tcp (all protocols)  </td>   
                                           </tr>
                                           <tr>
                                           <td>Destinations</td>
