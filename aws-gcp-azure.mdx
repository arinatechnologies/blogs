...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>Import/Export<br>Azure Data Box
      </td>
    </tr>
    <tr>
      <td></td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>Azure DNS<tr>Traffic Manager</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Load Balancer<br>Application Gateway</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>RDS</td>
      <td>Cloud SQL<br>Cloud Spanner<br>Database for PostgreSQL</td>
      <td>SQL Database<br>Database for MySQL</td>
    </tr>
    <tr>
      <td>NoSQL (Indexed)</td>
      <td>DynamoDB<br>Cloud Bigtable</td>
...
<table>
  <tbody>
    ...
    <tr>
      <td>Cloud Search</td>
      <td>CloudSearch<br>OpenSearch Service</td>
      <td>Search</td>
      <td>Azure Search</td>
    </tr>
    <tr>
      <td>Streaming Service</td>
      <td>Kinesis<br>Kinesis Video Streams</td>
    ...
    <tr>
      ...
      <td>QuickSight<br>Looker</td>
      <td>Google Data Studio</td>
      <td>PowerBI</td>
    </tr>
    <tr>
      <td>Cloud EtL</td>
      <td>AWS Data Pipeline<br>AWS Glue</td>
      <td>Cloud DataPrep<br>Cloud Data Fusion</td>
      <td>Azure Data Factory<br>Azure Data Catalog</td>
    </tr>
    <tr>
