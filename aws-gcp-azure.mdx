...
[Read more about Azure](https://www.arinatechnologies.com/posts/aws-gcp-azure)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>Elastic File System (EFS)\
      File Store</td>
      <td>ZFS / Avere</td>
      <td>Azure Files 
      Azure NetApp Files</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Import/Export Azure Data Box</td>
    </tr>
    <tr>
      <td></td>
      <td>Snowmobile</td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>RDS</td>
      <td>Cloud SQL Cloud Spanner Database for PostgreSQL</td>
      <td>SQL Database Database for MySQL</td>
    </tr>
    <tr>
      <td>NoSQL (Indexed)</td>
      <td>DynamoDB Cloud Bigtable</td>
      <td>Cloud Datastore</td>
      <td>Cosmos DB</td>
    </tr>
    <tr>
      <td>NoSQL (Key-value)</td>
      <td>DynamoDB SimpleDB</td>
      <td>Cloud Datastore</td>
      <td>table Storage</td>
    </tr>
    <tr>
...
<table>
  <tbody>
    ...
    <tr>
      <td>Cloud Search</td>
      <td>CloudSearch OpenSearch Service</td>
      <td>Search</td>
      <td>Azure Search</td>
    </tr>
    <tr>
      <td>Streaming Service</td>
      <td>Kinesis Kinesis Video Streams</td>
    ...
    <tr>
      ...
      <td>QuickSight Looker</td>
      <td>Google Data Studio</td>
      <td>PowerBI</td>
    </tr>
    <tr>
      <td>Cloud EtL</td>
      <td>AWS Data Pipeline AWS Glue</td>
      <td>Cloud DataPrep Cloud Data Fusion</td>
      <td>Azure Data Factory Azure Data Catalog</td>
    </tr>
    <tr>
...
Let’s discuss how we can optimize your business operations. Contact us for a consultation [ Contact Us](https://www.arinatechnologies.com/contact) <br/>
### Conclusion
