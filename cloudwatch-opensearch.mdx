---
title: 'How to Export AWS CloudWatch Logs to OpenSearch(Elasticsearch):A Complete Guide'
date: '2024-09-29'
...
tags: ['AWS CloudWatch', 'OpenSearch', 'Elasticsearch', 'Log Management', 'AWS Lambda','Cloud Management','AWS IAM Roles','Cloud Logging Solutions','AWS Cloud Infrastructure']
---
...
- **Retention Issues**: Its challenging to access logs beyond a certain retention period.
...
Now that we have our OpenSearch cluster, lets set up AWS CloudWatch to export logs.
